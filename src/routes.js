...
const GlobalsController = require('./app/controllers/globals_controller.js')
const multer = require('./app/middlewares/multer.js')

//! -------------------- global routes
routes.get('/', GlobalsController.index)
routes.get('/about', GlobalsController.about)
routes.get('/recipes', GlobalsController.recipes)
routes.get('/recipes/:id', GlobalsController.recipe)
routes.get('/search', GlobalsController.search)
routes.get('/chefs', GlobalsController.chefs)
routes.get('/chefs/:id', GlobalsController.chef)
